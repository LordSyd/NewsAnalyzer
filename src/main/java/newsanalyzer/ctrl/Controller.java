...
public class Controller {
	...
	public void process(String query,
		...
		try {
			newsResponse = (NewsReponse) getData(newsApi);
	...
	public Object getData(NewsApi newsApi) throws NewsApiException {
		...
		/*//
		long numberArticles;
		String authorShortestName = null;

		System.out.println(System.lineSeparator() + "Data analysis:" + System.lineSeparator());

		numberArticles = data.stream().count();
		System.out.println("Number of Articles: " + numberArticles + System.lineSeparator());
		...
		data
				...
				.ifPresent(e -> System.out.println("Most articles by "+ e.getKey().getSource().getName()));
		...
		if(authorShortestName != null){
			System.out.println("Author with shortest name: " + authorShortestName + System.lineSeparator());
		}

		System.out.println("Titles sorted alphabetically:");

		data.stream().sorted(Comparator.comparing(Article -> Article.getTitle().length())).forEach(e -> System.out.println(e.getTitle()));
